...
func (s *gcpState) configureServer(writers []upspin.UserName) error {
	// TODO(adg): this needn't be a method on gcpState as it's not at all
	// to do with GCP. Move it elsewhere if/when we decide to generalize
	// this to support other cloud service providers.
