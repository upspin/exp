	...
	browser.drawEntries = function() {
		...
		for (var i=0; i<browser.entries.length; i++) {
			...
			inspectEl.click(function() {
				inspector.inspect($(this).closest(".up-entry").data("up-entry"));
			});
...
var browser1 = new Browser(inspector);
var browser2 = new Browser(inspector);
$("body .container .row").append(browser1.element).append(browser2.element);
