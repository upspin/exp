...
// copyPaths recursively copies the specified source paths to the given
// destination. It uses Client.PutDuplicate to copy files, so no file data is
// copied and the underlying DirBlocks do not change.
