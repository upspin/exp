...
func (s *server) startup(req *http.Request) (*startupResponse, upspin.Config, error) {
	...
	case "configureServerHostName":
		...
		if hostName == "" {
			// TODO: user server config here and reverse the order
			// of configureServerHostName and configureServerUser.
	...
	case "configureServer":
		// TODO: notice about deleting the Owners private key json file.
		// TODO: configure writers on user inoput.
